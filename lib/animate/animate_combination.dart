...
/// 基础动画模块
class AnimateCombination extends StatefulWidget {
  const AnimateCombination({Key key}) : super(key: key);
  _BasicAnimateState createState() => _BasicAnimateState();
}

class _BasicAnimateState extends State<AnimateCombination>
